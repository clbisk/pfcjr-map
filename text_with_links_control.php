...
class Text_With_Links_Control extends Base_Data_Control {
	...
	public function enqueue() {
		// styles
		wp_enqueue_style('textwithlinks', plugins_url('textwithlinks.css', __FILE__), array(), '2.2.2.1');
		...
		$my_script_dependencies, '2.10.1.1', true);
	}
	...
	public function content_template() {
		...
		echo '			<button type="button" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#target-link-modal-' . esc_attr( $control_uid ) . '">';
